...
if uploaded_file:
    ...
    if image:
        ...
        def generate_pdf():
            ...
            font_regular = os.path.join(os.getcwd(), "DejaVuSans.ttf")
            font_bold = os.path.join(os.getcwd(), "DejaVuSans-Bold.ttf")
            ...
            if os.path.exists(font_regular) and os.path.exists(font_bold):
                ...
                pdf.set_font("Helvetica", size=14)  # Fallback für fehlende Fonts
